    ...
    <div class="login-form">
      <div class="login-form-block f-c-c">
        <form action="" method="post">
          ...
          <div class="sign-up-form-title">Thêm người bán</div>
          ...
          if($flag){
            ...
            $sql="insert into adminlogin(name,email,password) values ('".$name."','".$email."','".$password."')";
              if(mysqli_query($connect,$sql)){
                echo '<div class="register-success-form"><div class="register-success-content"><i class="fas fa-times"></i><div class="register-success-title">Thêm tài khoản thành công</div><a href="doanh-so-ban-hang">Đăng nhập</a></div></div>';
              }
          }
        }else{
